...
def main():
    ...
    print(f"전주시 2015년 연 강수량은 {sum(rainfall_2015):.1f}mm입니다.")
    print(f"전주시 2022년 최대기온은 {max(tavg_2022)}C입니다.")
    print(f"전주시 2024년 최대일교차는 {best_gap_2024(tmax_2024, tmin_2024)}C입니다.")
    print(f"수원시와 전주시 2024년 총강수량 차이는{rainfall_gap:.1f}mm입니다.")
